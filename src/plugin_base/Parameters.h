...
{
public:
    Parameter (clap_id param_id, std::string_view param_name)
    ...
    juce::dsp::FixedSizeFunction<24, std::string (float)> valueToText = nullptr;
    juce::dsp::FixedSizeFunction<8, float (const std::string&)> textToValue = nullptr;
...
{
public:
    FloatParameter (clap_id param_id,
